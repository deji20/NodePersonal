...
friends.push({"name":"mark", "age":21},{"name":"Tommy", "age":22}, {"name":"Dennis", "age":20});

friends.forEach(friend => console.log(`Hey! My name is ${friend.name} and im ${friend.age} years old.`));
// --------------------------------------
...
// --------------------------------------
// Exercise 8 - For loop and if statementø
